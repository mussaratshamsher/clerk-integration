...
export default function PaymentSuccess({ searchParams }: { searchParams: URLSearchParams }) {  
  const amount = searchParams.get('amount'); // Use .get() to retrieve the value as a string  
